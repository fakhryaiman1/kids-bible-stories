    ...
    <div className="space-y-12">
        ...
        <div className="relative grid items-center gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              <Link
                to="/stories"
                className="flex items-center gap-2 rounded-full bg-gradient-to-r from-sky-500 to-cyan-500 px-7 py-3.5 text-base font-black text-white shadow-lg shadow-sky-200 transition-transform hover:scale-105"
              >
                <BookOpen size={20} /> ابدأ القراءة الآن
              </Link>
              <Link
                to="/admin"
                className="flex items-center gap-2 rounded-full border border-slate-200 bg-white/90 px-6 py-3.5 text-base font-bold text-slate-700 shadow-sm transition-all hover:bg-slate-50"
              >
                لوحة الإدارة
              </Link>
            </div>
      ...
      <section className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Link to="/stories" className="text-sm font-bold text-sky-600 hover:underline">
            عرض كافة الفئات
          </Link>
        </div>
      ...
      <section className="grid gap-6 rounded-3xl border border-white/80 bg-gradient-to-br from-sky-50 via-indigo-50 to-amber-50 p-8 shadow-inner md:grid-cols-3">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h3 className="text-lg font-black text-slate-900">قاعدة بيانات مباشرة</h3>
          <p className="mt-2 text-sm text-slate-600">
            متصل مباشرة بـ Supabase لمزامنة التقدم والإنجازات في الوقت الفعلي.
          </p>
        </div>
      </section>
    </div>
